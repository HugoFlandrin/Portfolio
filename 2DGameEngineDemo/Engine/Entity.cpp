...
void Entity::createPhysics(b2Vec2 _size, b2BodyType _bodyType, bool _fixedRotation, float _density, float _friction, bool _isSensor, int _groupIndex) {
	...
	collider->init(rigidBody, _isSensor, _groupIndex);
